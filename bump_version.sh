...
echo ""
echo "Next steps:"
echo "  1. Add changelog entry to esp32s3/src/main.cpp (// v$NEW section above v$OLD)"
echo "  2. Add changelog entry to README.md (### v$NEW section)"
echo "  3. Build + flash + test"
echo "  4. git add -p && git commit && git tag v$NEW && git push --tags"
